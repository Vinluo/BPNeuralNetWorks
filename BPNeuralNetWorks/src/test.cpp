...
int main(int argc, char *argv[])
{
	...
	get_input_label("D:/WorkProject/OtherProject/BackPropagation/BPNeuralNetWorks/BPNeuralNetWorks/Data/input_label_1000.xml", input, label, sample_number);
	get_input_label("D:/WorkProject/OtherProject/BackPropagation/BPNeuralNetWorks/BPNeuralNetWorks/Data/input_label_1000.xml", test_input, test_label, 200, 800);
